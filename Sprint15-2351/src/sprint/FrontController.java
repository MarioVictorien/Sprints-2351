...
public class FrontController extends HttpServlet {
                ...
                while (i < urlParts.length) {
                    if (this.urlMap.containsKey(urlTarget)) {
                        ...
                        if(!mapping.contains(prevu)){//verifie si post ou get 
                            ...
                            displayError("Erreur de requête : Une requête de type "+prevu+" est attendue."+verbActu+" a été trouvée pour la methode", "404", rep);
                            return;
                        }
                        try {
    ...
    static FileMap getFileInfo(HttpServletRequest req,Parameter p) throws Exception{
        if(p.getType().equals(FileMap.class)){
            ...
            System.out.println("Nom param:"+annotation.name());
    ...
    static Object[] fileHandling(HttpServletRequest req,Parameter param) throws Exception{
        ...
        System.out.println("fichier receptionne : "+files.length+"Nom:");
        return files;
    }
}
