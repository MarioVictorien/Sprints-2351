...
public class FrontController extends HttpServlet {
                        ...
                        try {
                            ...
                            if (obj instanceof String) {
                                if(isJson((String)obj)){
                                    rep.setContentType("appliaction/json");
    ...
    public void viewExist(String viewUrl) throws Exception {
        ...
        if (!listView.contains(viewUrl)) {
            throw new Exception("Error 404 : This page " + viewUrl + " doesn't exist!");
        }
    }
    //si la methodExist
    public void methodExist(String urlMethod) throws Exception {
        ...
        throw new Exception("Error 404 : the " + urlMethod + " isn't affected to this project");
    }
